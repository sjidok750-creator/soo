...
// ─── 파일 선택 바텀시트 (NotesPage MediaPickerSheet 스타일) ───────
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end"
      ...
      <div className="relative rounded-3xl overflow-hidden mx-4 mb-3 bg-white" onClick={e => e.stopPropagation()}>
        ...
        <button onClick={onGallery} className="w-full flex items-center gap-5 px-6 py-4 active:bg-gray-50 transition-colors">
        ...
        <button onClick={onCamera} className="w-full flex items-center gap-5 px-6 py-4 active:bg-gray-50 transition-colors">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1C1C1E" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mx-6 h-px bg-gray-100" />
        <button onClick={onFiles} className="w-full flex items-center gap-5 px-6 py-4 active:bg-gray-50 transition-colors">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1C1C1E" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/>
          </svg>
